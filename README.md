...
<div align="center">
  ...
  Halloween Website 🎃 is a fully responsive website, <br />Responsive for all devices, build using HTML, CSS, and JavaScript.

  <a href="https://web-halloween.netlify.app"><strong>➥ Live Demo</strong></a>
...
To run **Halloween Website 🎃** locally, run this command on your git bash:

Linux and macOS:

```bash
sudo git clone https://github.com/Asifmohamed007/Halloween-Website.git
```

Windows:

```bash
git clone https://github.com/Asifmohamed007/Halloween-Website.git
```
